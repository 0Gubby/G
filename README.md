...
function Library:CreateWindow(HubTitle, HubSubtitle)
    ...
    TweenService:Create(Blur, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {Size = 16}):Play()

    local LoadContainer = Instance.new("Frame")
    LoadContainer.Size = UDim2.fromOffset(300, 150)
    LoadContainer.Position = UDim2.fromScale(0.5, 0.5)
    ...
    LoadAvatar.Size = UDim2.fromOffset(50, 50)
    LoadAvatar.Position = UDim2.new(0.5, -25, 0, 10)
    LoadAvatar.BackgroundColor3 = Color3.fromRGB(20, 15, 30)
    LoadAvatar.BackgroundTransparency = 1
    LoadAvatar.ImageTransparency = 1
    LoadAvatar.ZIndex = 102
    LoadAvatar.Parent = LoadContainer
    ...
    WelcomeLabel.Size = UDim2.new(1, 0, 0, 24)
    WelcomeLabel.Position = UDim2.fromOffset(0, 70)
    WelcomeLabel.BackgroundTransparency = 1
    WelcomeLabel.Text = "Welcome,"
    WelcomeLabel.Font = Enum.Font.GothamMedium
    WelcomeLabel.TextSize = 14
    WelcomeLabel.TextColor3 = Color3.fromRGB(150, 140, 175)
    WelcomeLabel.TextTransparency = 1
    WelcomeLabel.ZIndex = 102
    WelcomeLabel.Parent = LoadContainer

    local UserLabel = Instance.new("TextLabel")
    UserLabel.Size = UDim2.new(1, 0, 0, 24)
    UserLabel.Position = UDim2.fromOffset(0, 92)
    ...
    UserLabel.Parent = LoadContainer

    task.spawn(function()
        local success, content = pcall(function()
            return Players:GetUserThumbnailAsync(Player.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
        end)
        if success then LoadAvatar.Image = content end
        
        TweenService:Create(LoadAvatar, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {ImageTransparency = 0}):Play()
        TweenService:Create(WelcomeLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
        task.wait(0.1)
        TweenService:Create(UserLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
        
        task.wait(1.8)
        
        TweenService:Create(LoadAvatar, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {ImageTransparency = 1}):Play()
        TweenService:Create(WelcomeLabel, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
        TweenService:Create(UserLabel, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
        TweenService:Create(Blur, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {Size = 0}):Play()
        local bgTween = TweenService:Create(LoadingBg, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {BackgroundTransparency = 1})
        bgTween:Play()
    ...
    -- =========================================================================
    -- MAIN WINDOW (LARGE CONFIGURATION)
    -- =========================================================================
    ...
    -- =========================================================================
    -- MINIATURIZED PROFILE CORNER FOOTER
    -- =========================================================================
    ...
    function Window:CreateButton(Name, Callback)
        ...
        SheenBar.BackgroundTransparency = 0
        SheenBar.ZIndex = 2
        ...
        ButtonFrame.MouseButton1Click:Connect(function()
            SheenBar.Position = UDim2.new(-2, 0, 0, 0)
            TweenService:Create(ButtonFrame, TweenInfo.new(0.05, Enum.EasingStyle.Quad), {Size = UDim2.new(1, -6, 0, 42), Position = UDim2.fromOffset(3, YPos + 2)}):Play()
            TweenService:Create(SheenBar, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {Position = UDim2.new(1, 0, 0, 0)}):Play()
            task.wait(0.05)
            TweenService:Create(ButtonFrame, TweenInfo.new(0.05, Enum.EasingStyle.Quad), {Size = UDim2.new(1, 0, 0, 46), Position = UDim2.fromOffset(0, YPos)}):Play()
    ...
    -- =========================================================================
    -- MINIMIZE / INTERACTIVE FUNCTIONS
    -- =========================================================================
    Minimize.MouseButton1Click:Connect(function()
        ...
        if Minimized then
            ...
            TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.fromOffset(460, 60)}):Play()
            Minimize.Text = "+"
        else
            TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.fromOffset(460, Window.MaxHeight)}):Play()
            Minimize.Text = "•"
            task.wait(0.15)
